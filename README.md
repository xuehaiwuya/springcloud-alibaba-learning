...
## 1. 统一的依赖管理
### 依赖管理项目 - spring-cloud-alibaba-dependencies
...
![img](https://github.com/mirrormingzZ/spring-cloud-alibaba/blob/master/spring-cloud-alibaba-nacos-server/resources/nacos-start.png?raw=true)
...
![img](https://github.com/mirrormingzZ/spring-cloud-alibaba/blob/master/spring-cloud-alibaba-nacos-server/resources/nacos.png?raw=true)


## 3. 服务提供者 - spring-cloud-alibaba-provider
...
![img](https://github.com/mirrormingzZ/spring-cloud-alibaba/blob/master/spring-cloud-alibaba-nacos-server/resources/nacos-provider.png?raw=true)
...
![img](https://github.com/mirrormingzZ/spring-cloud-alibaba/blob/master/spring-cloud-alibaba-nacos-server/resources/nacos-discovery.png?raw=true)
...
## 4. 创建服务消费者 - spring-cloud-alibaba-consumer
...
```java
package com.studyinghome.spring.cloud.alibaba.consumer.config;
...
![img](https://github.com/mirrormingzZ/spring-cloud-alibaba/blob/master/spring-cloud-alibaba-nacos-server/resources/consumer.png?raw=true)
...
![img](https://github.com/mirrormingzZ/spring-cloud-alibaba/blob/master/spring-cloud-alibaba-nacos-server/resources/nacos-discovery2.png?raw=true)

## 5. 创建服务消费者（Feign）- spring-cloud-alibaba-nacos-consumer-feign
...
```java
package com.studyinghome.spring.cloud.alibaba.consumer.feign.service;
...
![img](https://github.com/mirrormingzZ/spring-cloud-alibaba/blob/master/spring-cloud-alibaba-nacos-server/resources/loadbalance-setting.png?raw=true)
...
import com.studyinghome.spring.cloud.alibaba.consumer.feign.service.fallback.ProviderServiceFallback;
import org.springframework.cloud.openfeign.FeignClient;
import org.springframework.web.bind.annotation.GetMapping;
import org.springframework.web.bind.annotation.PathVariable;
...
```java
package com.studyinghome.spring.cloud.alibaba.consumer.feign.service.fallback;

import com.studyinghome.spring.cloud.alibaba.consumer.feign.service.ProviderService;
...
![img](https://github.com/mirrormingzZ/spring-cloud-alibaba/blob/master/spring-cloud-alibaba-nacos-server/resources/sentinel-dashboard.png?raw=true)
...
![img](https://github.com/mirrormingzZ/spring-cloud-alibaba/blob/master/spring-cloud-alibaba-nacos-server/resources/gateway.jpg?raw=true)
...
```java
package com.studyinghome.spring.cloud.gateway;
...
![img](https://github.com/mirrormingzZ/spring-cloud-alibaba/blob/master/spring-cloud-alibaba-nacos-server/resources/gateway-filter.jpg?raw=true)
...
```java
package com.studyinghome.spring.cloud.gateway.filter;
...
![img](https://github.com/mirrormingzZ/spring-cloud-alibaba/blob/master/spring-cloud-alibaba-nacos-server/resources/nacos-config.png?raw=true)

![img](https://github.com/mirrormingzZ/spring-cloud-alibaba/blob/master/spring-cloud-alibaba-nacos-server/resources/nacos-config2.png?raw=true)
...
![autoupdate](https://github.com/mirrormingzZ/spring-cloud-alibaba/blob/master/spring-cloud-alibaba-nacos-server/resources/nacos-config-autoupdate.png?raw=true)
...
```bash
java -jar spring-cloud-alibaba-nacos-provider-1.0.0-SNAPSHOT.jar --spring.profiles.active=prod
```
...
```java
package com.studyinghome.spring.cloud.alibaba.rocketmq.provider.service;
...
```java
package com.studyinghome.spring.cloud.alibaba.rocketmq.provider.controller;

import com.studyinghome.spring.cloud.alibaba.rocketmq.provider.service.ProviderService;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.web.bind.annotation.GetMapping;
...
```java
package com.studyinghome.spring.cloud.alibaba.rocketmq.provider;
...
<project xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    ...
    <artifactId>spring-cloud-alibaba-rocketmq-consumer</artifactId>
    <packaging>jar</packaging>

    <name>spring-cloud-alibaba-rocketmq-consumer</name>
    ...
    <build>
        <plugins>
            <plugin>
                ...
                <configuration>
                    <mainClass>com.studyinghome.spring.cloud.alibaba.rocketmq.consumer.RocketMQConsumerApplication</mainClass>
                </configuration>
            </plugin>
        </plugins>
    </build>
...
```java
package com.studyinghome.spring.cloud.alibaba.rocketmq.consumer.service;
...
```java
package com.studyinghome.spring.cloud.alibaba.rocketmq.consumer;
